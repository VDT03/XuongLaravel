...
@section('title')
    Cập nhật nhân viên: {{ $employee->first_name }}
@endsection

@section('content')
    <h1>Cập nhật nhân viên: {{ $employee->first_name }}</h1>
    ...
    <div class="container">
        <form method="POST" action="{{ route('employees.update', $employee) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="number" class="form-control" name="manager_id" id="manager_id" value="{{ $employee->manager_id }}" />
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-8">
                    <input type="checkbox" class="form-checkbox" @checked($employee->is_active) value="1" name="is_active" id="is_active" />
                </div>
            </div>
            <div class="mb-3 row">
